...
class Mk_Artbees_Captcha
{
    ...
    protected function ImageAllocate()
    {
        ...
        // Background color
        $this->GdBgColor = imagecolorallocatealpha($this->im, $this->backgroundColor[0], $this->backgroundColor[1], $this->backgroundColor[2], 127);
        ...
        if (!empty($this->shadowColor) && is_array($this->shadowColor) && sizeof($this->shadowColor) >= 3) {
            $this->GdShadowColor = imagecolorallocatealpha($this->im, $this->shadowColor[0], $this->shadowColor[1], $this->shadowColor[2], 0);
        }
    }
    ...
    protected function WriteImage()
    {
        if ($this->imageFormat == 'png' && function_exists('imagepng')) {
            ...
            base64_encode(imagepng($this->im));
        } else {
